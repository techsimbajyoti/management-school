                            ...
                            <div class="row ">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-lg ot-btn-primary save_1"><i class="fa fa-save"></i> {{ __('Save & Continue') }}</button>
                                        <button type="submit" class="btn btn-lg ot-btn-primary ml-3"><i class="fa fa-save"></i> {{ __('Save') }}</button>
                                    </div>
                                </div>
                            </form>
