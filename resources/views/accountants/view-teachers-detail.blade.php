                    ...
                    <div class="col-12">
                        <div class="card ot-card mb-24 position-relative z_1">
                           <div class="card-header d-flex justify-content-between align-items-center">
                             <h3 class="title mb-0">Staff Detail</h3>
                             <a href="{{ route('accountant-teacher') }}" class="btn btn-lg ot-btn-primary mb-4"><span class=""><i class="fa fa-arrow-left"></i>  Back</span></a>
                           </div>
                         </div>
                   </div>
                        <div class="col-lg-4">
