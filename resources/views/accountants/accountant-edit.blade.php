                ...
                <div class="col-12">
                    <div class="card ot-card mb-24 position-relative z_1">
                       <div class="card-header d-flex justify-content-between align-items-center">
                         ...
                         <a class="btn btn-lg ot-btn-primary mb-4" id="accountant-edit-profile"><span class=""><i class="fa fa-edit"></i>  Edit</span></a>
                       </div>
                     </div>
               </div>
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">Accounts and Finance</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
