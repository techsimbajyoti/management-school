@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'student-attendance'
])
        ...
        <div class="col-12">
              ...
              <div class="card ot-card mb-24 position-relative z_1">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <a   href="{{ route('student-attendance')}}"class="btn btn-lg ot-btn-primary mb-4"><span class=""><i class="fa fa-arrow-left"></i>  Back</span></a>
                </div>
