                ...
                <div class="card ot-card">
                    ...
                    <div class="card-body">
                        <form action="" enctype="multipart/form-data" method="post" id="visitForm" name="visitForm">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label for="exampleInputEmail1" class="form-label">Email <span class="fillable">*</span><span class="text-info" style="font-size:0.85rem;"> (This email is your Login Id)</span></label> <input type="email" name="email" value="" class="form-control ot-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your email">
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label for="exampleDataList" class="form-label">Contact <span class="fillable">*</span></label> <input class="form-control ot-input" name="phone" value="" list="datalistOptions" id="exampleDataList" placeholder="Enter phone">
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label for="exampleDataList" class="form-label">Salary <span class="fillable">*</span></label> <input class="form-control ot-input" name="basic_salary" value="" list="datalistOptions" id="exampleDataList" type="number" placeholder="Enter basic salary">
                            </div>
                            <div class="col-lg-6  mb-3">
                                <label for="exampleDataList" class="form-label">Current address</label>
                                 <textarea class="form-control ot-input" name="current_address" value="" list="datalistOptions" id="exampleDataList" placeholder="   Enter current address"></textarea>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="exampleDataList" class="form-label">Permanent Address</label>
                                <textarea class="form-control ot-input" name="permanent_address" id="exampleDataList" placeholder="   Enter Permanent address"></textarea>
                            </div>
                            ...
                            <div class="col-md-12 mt-24">
                                <div class="text-right">
                                    <a href="{{route('teachers')}}" class="btn ot-btn-primary"><span><i class="fa-solid fa-refresh"></i>
                                    </span>Update</a>
                                </div>
                            </div>
                        </form>
