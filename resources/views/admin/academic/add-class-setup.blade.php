                  ...
                  <form action="" enctype="multipart/form-data" method="" id="visitForm" name="visitForm">
                    ...
                    <div class="row mb-3">
                      <div class="col-lg-12">
                        ...
                        <div class="col-md-6">
                          <label for="validationServer04" class="form-label">Attendance <span class="fillable">*</span></label> <select class="nice-select niceSelect bordered_style wide" name="status" id="validationServer04" aria-describedby="validationServer04Feedback">
                            <option value="1">
                              Subject
                            </option>
                            <option value="0">
