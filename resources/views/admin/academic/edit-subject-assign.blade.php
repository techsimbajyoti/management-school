@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'edit-subject-assign'
])
@section('content')
<div class="content">
    @if (session('status'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Subject Assign</h4>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 mt-24">
                            <div class="text-right">
                              <a href="{{route('assign-subject')}}" class="btn btn-lg ot-btn-primary"><i class="fa fa-save"></i> Update</a>
                            </div>
                          </div>
                        </div>
                      </div>
