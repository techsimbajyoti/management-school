                    ...
                    <div class="row mb-3">
                      <div class="col-lg-12">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <label for="validationServer04" class="form-label">Type <span class="fillable">*</span></label> <select class="nice-select niceSelect bordered_style wide" name="type" id="validationServer04" aria-describedby="validationServer04Feedback">
                              <option value="1">
                                Theory
                              </option>
                              <option value="2">
                          ...
                          <div class="col-md-12 mt-24">
                            <div class="card-footer">
                              <div class="d-flex justify-content-end">
                                  ...
                                  <a href="{{ route('subject') }}" class="btn btn-lg ot-btn-primary ml-3"><i class="fa fa-save"></i> {{ __('Save') }}</a>
                              </div>
                          </div>
                          </div>
                        </div>
