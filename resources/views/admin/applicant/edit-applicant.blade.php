                                ...
                                <form class="form" method="POST" id="form3">
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-lg ot-btn-primary save_3"><i class="fa fa-pen"></i> {{ __('Update & Next') }}</button>
                                ...
                                <form id="form4" class="form" method="POST">
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-lg ot-btn-primary save_4"><i class="fa fa-pen"></i> {{ __('Update') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
