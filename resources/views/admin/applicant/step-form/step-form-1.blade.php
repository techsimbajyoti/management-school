<form class="form" method="POST" action="" id="form1">
    ...
    <input type="hidden" name="applicant_id" class="applicant_id">
    <input type="hidden" name="student_id" class="student_id">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="password" name="password" id="password" autocomplete="off" class="nice-select niceSelect bordered_style wide" placeholder="Enter Password"  title="Eight or more characters" required>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="password" name="password_confirmation" class="nice-select niceSelect bordered_style wide" placeholder="Enter Confirm Password"      title="Eight or more characters" required>
