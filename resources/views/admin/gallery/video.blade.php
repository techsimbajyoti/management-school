                ...
                <div class="table-content table-basic mt-20">
                    <div class="card ot-card">
                      <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{route('add-video')}}" class="btn btn-lg ot-btn-primary"><i class="fa fa-plus"></i> Add</a>
                        @elseif(auth()->guard('webteachers')->check() && auth()->guard('webteachers')->user()->role_id == 2)
                        <a href="{{route('teacher-add-video')}}" class="btn btn-lg ot-btn-primary"><i class="fa fa-plus"></i> Add</a>
                        @endif
                          ...
                          <table class="table table-bordered class-table myTable">
                            <thead class="thead">
                              <tr>
                                ...
                                <th class="purchase">Video Image</th>
