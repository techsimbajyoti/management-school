                          ...
                          <div class="col-lg-12">
                            <div class="row">
                              ...
                              <div class="col-md-6 mb-3">
                                <label for="validationServer04" class="form-label">Video Link <span class="fillable">*</span></label>
                                 <input type="text" name="video_link" placeholder="http://example.com" class="nice-select niceSelect bordered_style wide" name="status">
                              </div>
