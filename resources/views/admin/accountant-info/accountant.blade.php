        ...
        <div class="row">
            ...
            <div class="table-content table-basic mt-20">
                <div class="card">
                    ...
                    <h4 class="mb-0 title">Accountant</h4><a href="{{ route('admit-accountant') }}" class="btn btn-lg ot-btn-primary"><i class="fa fa-plus"> Add</i></a>
                    </div>
                    <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <thead class="thead">
                            ...
                            <th class="purchase">Accountant ID</th>
