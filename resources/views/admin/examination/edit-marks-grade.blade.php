@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'edit-marks-grade'
])
@section('content')
<div class="content">
    @if (session('status'))
        ...
        <div class="col-md-12">
            <div class="card ot-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Marks grade</h4><a href="{{route('marks-grade')}}" class="btn btn-lg ot-btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                  </div>
                  <hr>
                <div class="card-body">
