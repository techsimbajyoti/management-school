@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'edit-exam-assign'
])
@section('content')
<div class="content">
    @if (session('status'))
        ...
        <div class="col-md-12">
            <div class="card ot-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Exam Assign</h4><a href="{{route('exam-assign')}}" class="btn btn-lg ot-btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                  </div>
                  <hr>
                <div class="card-body">
