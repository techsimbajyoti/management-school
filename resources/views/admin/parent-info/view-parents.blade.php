            ...
            <div class="col-md-12">
                <div class="card ot-card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 title">View Parents</h4><a href="{{ route('parents') }}" class="btn ot-btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <hr>
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input" name="confirm_password" list="datalistOptions" id="exampleDataList" placeholder="Enter father login id" type="password" value="123456789">
                                 </div>
                                 <div class="col-md-3 mb-3">
