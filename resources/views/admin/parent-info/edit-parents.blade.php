            ...
            <div class="col-md-12">
                <div class="card ot-card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 title">Edit Parent</h4><a href="{{ route('parents') }}" class="btn ot-btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <hr>
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="text-right">
                                    <a href="{{route('parents')}}" class="btn ot-btn-primary"><i class="fa fa-refresh"></i> Update</a>
                                </div>
                                </div>
                            </div>
                            </div>
