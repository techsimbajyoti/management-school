<div class="profile-body edit-teacher-profile">
    ...
    <form action="" enctype="multipart/form-data" method="post" id="visitForm" name="visitForm">
            ...
            <div class="col-lg-4 col-md-8 mb-3">
                ...
                <input class="form-control ot-input" name="staff_id" value="" list="datalistOptions" id="exampleDataList" type="number" placeholder="Enter staff ID">
            </div>
            <div class="col-lg-4 col-md-8 mb-3">
            ...
            <div class="col-md-12 mt-24">
                <div class="text-right">
                    <button class="btn ot-btn-primary"><span><i class="fa-solid fa-save"></i>
                    </span>Submit</button>
                </div>
            </div>
        </form>
